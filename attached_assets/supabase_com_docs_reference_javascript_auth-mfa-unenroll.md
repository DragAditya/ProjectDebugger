URL: https://supabase.com/docs/reference/javascript/auth-mfa-unenroll
---
...
`\
\
### Explicit constructor options [\#](https://supabase.com/docs/reference/javascript/auth-mfa-unenroll\#explicit-constructor-options)\
\
...
`\
\
### TypeScript support [\#](https://supabase.com/docs/reference/javascript/auth-mfa-unenroll\#typescript-support)\
\
...
`\
\
### Data operations return minimal [\#](https://supabase.com/docs/reference/javascript/auth-mfa-unenroll\#data-operations-return-minimal)\
\
...
`\
\
### New ordering defaults [\#](https://supabase.com/docs/reference/javascript/auth-mfa-unenroll\#new-ordering-defaults)\
\
...
\
### Cookies and localstorage namespace [\#](https://supabase.com/docs/reference/javascript/auth-mfa-unenroll\#cookies-and-localstorage-namespace)\
\
...
``\
\
### New Auth Types [\#](https://supabase.com/docs/reference/javascript/auth-mfa-unenroll\#new-auth-types)\
\
...
`\
\
### New Auth methods [\#](https://supabase.com/docs/reference/javascript/auth-mfa-unenroll\#new-auth-methods)\
\
...
`\
\
### New Realtime methods [\#](https://supabase.com/docs/reference/javascript/auth-mfa-unenroll\#new-realtime-methods)\
\
...
`\
\
### Deprecated setAuth() [\#](https://supabase.com/docs/reference/javascript/auth-mfa-unenroll\#deprecated-setauth)\
\
...
\
### All changes [\#](https://supabase.com/docs/reference/javascript/auth-mfa-unenroll\#all-changes)\
\
- `supabase-js`\
